...
var Get_ASC_Sorted_Prime_Numbers_Occuring_In_Two_Arrays = function(_array1, _array2) {
    ...
    if (_that.helpers.check.array_contains_only_numbers(_array1) === false)
        throw new Error("First Array does not contains only numbers!");
    if (_that.helpers.check.array_contains_only_numbers(_array2) === false)
        throw new Error("Second Array does not contains only numbers!");
