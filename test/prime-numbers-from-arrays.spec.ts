import getPrimeNumbersFromArrays from '@/prime-numbers-from-arrays'
...
describe('Integration tests', () => {
  describe('Arguments number', () => {
    ...
    it('should return [3, 5, 7] when 10 Array has been passed', () => {
      const myArray: number[][] = [...Array(10).keys()]
        .map((_element, _index) => [3 * _index, 5 * _index, 7 * _index, 9 * _index])
